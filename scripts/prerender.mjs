// scripts/prerender.mjs  (laplandstore)
//
// Non-invasive, react-snap–style post-build prerender for the LaplandStore SPA.
...
// ---- Locale prefixes (must match src/App.tsx + src/lang) -------------------
