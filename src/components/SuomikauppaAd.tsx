...
const SK_COPY: ProductAdCopy = {
  ...
  sub: {
    ...
    es: 'Un Mariskooli de Iittala, las tijeras naranjas de Fiskars, un fluido Nordic-C de Lumene: cosas que se consiguen en Finlandia y no tan fácilmente en casa. Suomikauppa envía con DHL, FedEx, GLS, PostNord y Posti, así que el paquete llega a Osaka igual de fácil que a Oulu.',
