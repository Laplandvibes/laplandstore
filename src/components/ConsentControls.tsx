...
const COPY: Record<Lang, {
  ...
  nl: {
    h: 'Jouw keuze',
    accepted: 'Je hebt analyse- en partnercookies geaccepteerd.',
    declined: 'Je hebt analyse- en partnercookies geweigerd.',
    none: 'Je hebt nog geen keuze gemaakt. Tot dan wordt er niets geladen.',
