...
const COPY: Record<Lang, {
  ...
  es: {
    h: 'Su elección',
    accepted: 'Ha aceptado las cookies de analítica y de socios.',
    declined: 'Ha rechazado las cookies de analítica y de socios.',
    none: 'Aún no ha elegido. No se carga nada hasta entonces.',
