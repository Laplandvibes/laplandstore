...
const PRODUCTS: ReadonlyArray<{
...
}> = [
  {
    ...
    price: { fi: 'alk. 49 €', en: 'from €49', de: 'ab 49 €', ja: '€49 〜', es: 'desde 49 €', 'pt-BR': 'a partir de €49', 'zh-CN': '49 € 起', ko: '49 €부터', fr: 'à partir de 49 €', it: 'da 49 €', nl: 'vanaf € 49' },
    tagline: {
  ...
  {
    name: { fi: 'Saamelaishopeakoru', en: 'Sámi Silver Jewellery', de: 'Sámi-Silberschmuck', ja: 'サーミの銀細工アクセサリー', es: 'Joyas sami de plata', 'pt-BR': 'Joias sámi de prata', 'zh-CN': '萨米银饰', ko: '사미 은세공 장신구', fr: 'Bijoux sami en argent', it: 'Gioielli sami in argento', nl: 'Sami-zilverwerk' },
    price: { fi: 'alk. 79 €', en: 'from €79', de: 'ab 79 €', ja: '€79 〜', es: 'desde 79 €', 'pt-BR': 'a partir de €79', 'zh-CN': '79 € 起', ko: '79 €부터', fr: 'à partir de 79 €', it: 'da 79 €', nl: 'vanaf € 79' },
    tagline: {
  ...
  {
    name: { fi: 'Pentik-keramiikka', en: 'Pentik ceramics', de: 'Pentik-Keramik', ja: 'Pentik(ペンティック)の陶器', es: 'Cerámica Pentik', 'pt-BR': 'Cerâmica Pentik', 'zh-CN': 'Pentik 陶瓷', ko: 'Pentik 도자기', fr: 'Céramique Pentik', it: 'Ceramiche Pentik', nl: 'Pentik-keramiek' },
    price: { fi: 'alk. 25 €', en: 'from €25', de: 'ab 25 €', ja: '€25 〜', es: 'desde 25 €', 'pt-BR': 'a partir de €25', 'zh-CN': '25 € 起', ko: '25 €부터', fr: 'à partir de 25 €', it: 'da 25 €', nl: 'vanaf € 25' },
    tagline: {
