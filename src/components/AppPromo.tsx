...
const COPY: Record<string, Copy> = {
  ...
  de: {
    ...
    lead: 'Noch nie hat jemand das gesamte finnische Lappland an einem Ort versammelt. Jede Gemeinde, jede Piste, jede Ladesäule, jeder Startpunkt eines Wanderwegs. Und es funktioniert auch dann, wenn kein Netz mehr da ist.',
    stats: ['Gemeinden', 'Pisten', 'Lifte', 'geprüfte Orte'],
    features: [
      'Pisten- und Liftzahlen für neun Gebiete',
      'Ladesäulen für E-Autos und Tankstellen',
      'Wanderwege, Wildnishütten und Campingplätze',
