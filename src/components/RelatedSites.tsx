...
const COPY: Record<Lang, { eyebrow: string; h2: string; cards: Card[] }> = {
  en: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Christmas market shopping', body: 'Festive markets, makers and seasonal finds in the North.' },
      { href: 'https://laplandvisit.com', label: 'Plan a Lapland visit', body: 'Where to go, when to travel and how to get around.' },
    ],
  },
  fi: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Joulumarkkinaostokset', body: 'Joulumarkkinat, tekijät ja kauden löydöt pohjoisessa.' },
      { href: 'https://laplandvisit.com', label: 'Suunnittele Lapin matka', body: 'Minne mennä, milloin matkustaa ja miten liikkua.' },
    ],
  },
  de: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Einkauf auf Weihnachtsmärkten', body: 'Weihnachtsmärkte, Hersteller und saisonale Funde im Norden.' },
      { href: 'https://laplandvisit.com', label: 'Lappland-Reise planen', body: 'Wohin, wann reisen und wie man sich fortbewegt.' },
    ],
  },
  ja: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'クリスマスマーケットでの買い物', body: '北国の市、作り手、季節の品々。' },
      { href: 'https://laplandvisit.com', label: 'ラップランド旅行を計画する', body: 'どこへ行くか、いつ旅するか、どう移動するか。' },
    ],
  },
  es: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Compras en mercados navideños', body: 'Mercados, artesanos y hallazgos de temporada en el norte.' },
      { href: 'https://laplandvisit.com', label: 'Planee un viaje a Laponia', body: 'Adónde ir, cuándo viajar y cómo moverse.' },
    ],
  },
  'pt-BR': {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Compras em mercados de Natal', body: 'Mercados, artesãos e achados de temporada no norte.' },
      { href: 'https://laplandvisit.com', label: 'Planeje uma visita à Lapônia', body: 'Aonde ir, quando viajar e como se locomover.' },
    ],
  },
  'zh-CN': {
    eyebrow: '网络中的更多内容',
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: '圣诞市集购物', body: '北方的节庆市集、手作人与应季好物。' },
      { href: 'https://laplandvisit.com', label: '规划拉普兰之行', body: '去哪里、何时出行、如何出行。' },
    ],
  },
  ko: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: '크리스마스 마켓 쇼핑', body: '북녘의 축제 마켓과 만드는 이들, 그리고 계절의 발견.' },
      { href: 'https://laplandvisit.com', label: '라플란드 방문 계획하기', body: '어디로, 언제 떠나고, 어떻게 이동할지.' },
    ],
  },
  fr: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Achats aux marchés de Noël', body: 'Marchés, artisans et trouvailles de saison dans le Nord.' },
      { href: 'https://laplandvisit.com', label: 'Préparer un voyage en Laponie', body: 'Où aller, quand partir et comment se déplacer.' },
    ],
  },
  it: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Acquisti ai mercatini di Natale', body: 'Mercatini, artigiani e trovate di stagione nel Nord.' },
      { href: 'https://laplandvisit.com', label: 'Pianifica una visita in Lapponia', body: 'Dove andare, quando viaggiare e come spostarsi.' },
    ],
  },
  nl: {
    ...
    cards: [
      ...
      { href: 'https://laplandchristmas.com', label: 'Winkelen op kerstmarkten', body: 'Feestelijke markten, makers en seizoensvondsten in het noorden.' },
      { href: 'https://laplandvisit.com', label: 'Plan een bezoek aan Lapland', body: 'Waar naartoe, wanneer reizen en hoe je je verplaatst.' },
    ],
  },
};
