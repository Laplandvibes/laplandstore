...
const COPY: Record<Lang, Copy> = {
  ...
  nl: {
    ...
    title: 'De kou vraagt niet wat u hebt ingepakt',
    lead: 'Er is een moment in een Laplandse winter dat iedereen onthoudt: de deur gaat open, de lucht is zo droog en helder dat u hem in uw neus voelt, en de sneeuw knerpt onder uw laarzen. Daarna hangt alles af van wat er tegen uw huid ligt. Katoen wordt nat en koud, merino blijft warm ook als het vochtig is, en handschoenen bepalen hoe lang u naar de hemel kunt blijven kijken. We hebben vier mandjes rechtstreeks in de winkelwagen van de shop gezet. Kies een maat en open het mandje, alleen adres en betaling blijven over.',
    ...
    baskets: {
      merino_men: { scene: 'De ochtend op de huskyfarm', story: ['U komt aan terwijl het nog donker is. De honden horen de auto voordat u ze ziet, en honderd stemmen gaan tegelijk omhoog: ze willen vertrekken. De slee ligt laag, de snelheid komt op de eerste heuvel, en ruim twintig graden vorst stroomt over uw gezicht als water.', 'Een uur later weet u wat u eronder hebt aangetrokken. Katoen werd nat op de eerste klim en is nu een koude film op de huid. Merino houdt het vocht in de vezel en blijft verwarmen, ook vochtig, en de sokken doen hetzelfde. Dit mandje is de laag die geen foto laat zien, en de reden dat de mensen op de foto\'s lachen.'], name: 'Merino-onderkleding, heren', shipping: 'Levert alleen binnen Finland (Posti, Matkahuolto, PostNord).' },
      merino_women: { scene: 'Het wachten op het noorderlicht', story: ['Het noorderlicht houdt zich niet aan afspraken. Het komt na elven, of om half een, of helemaal niet, en intussen staat u in de sneeuw naar het noorden te kijken. Eerst praat u, dan wordt u stil, en uiteindelijk hoort u alleen uw eigen ademhaling en vraagt u zich af hoe stil een plek kan zijn.', 'Dan beslist wat er tegen de huid ligt. Een lichaam dat stilstaat maakt geen warmte, en merino is de vezel die toch verwarmt. Twee paar sokken betekent dat er \'s ochtends één paar droog is. Dezelfde set in damesmaten, muts erbij, zodat het wachten zo lang duurt als de hemel vraagt.'], name: 'Merino-onderkleding, dames', shipping: 'Levert alleen binnen Finland (Posti, Matkahuolto, PostNord).' },
      hands_feet: { scene: 'De foto die u met blote vingers maakt', story: ['Net als de groene boog begint te bewegen, gaat de handschoen uit, omdat de telefoon er niet doorheen luistert. Drie foto\'s, en de vingers zijn hout. Dat is de stille waarheid van de reis: de kou komt niet door de jas maar door vingers en tenen, omdat het lichaam het bloed naar de kern trekt en de randen aan hun lot overlaat.', 'Fleecehandschoenen waarvan duim en wijsvinger het scherm bedienen, skisokken en een merinomuts. Drie kleine dingen die bepalen of de avond de hele boog duurt of alleen het begin.'], name: 'Handen en voeten in de kou', shipping: 'Levert alleen binnen Finland (Posti, Matkahuolto, PostNord).' },
      socks_week: { scene: 'De hut heeft vloerverwarming, het fjell niet', story: ['Een week Lapland is eigenlijk een week voor uw voeten. \'s Ochtends lopen ze het fjell op, \'s middags staan ze in natte laarzen in de rij bij een café, \'s avonds zoeken ze na de sauna een warme vloer. Sokken, ingepakt met één paar per dag, zijn dinsdag op.', 'Drie paar merino: dikke voor de wandeling, tencel-merino dat overdag droog blijft, dunnere voor de avond en de terugreis. Het goedkoopste mandje, en het eerste dat u mist.'], name: 'Wollen sokken voor een week', shipping: 'Gratis verzending binnen Finland vanaf 50 €, andere landen bij de kassa.' },
    },
  },
  'pt-BR': {
