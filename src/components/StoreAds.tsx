...
const SO_COPY: ProductAdCopy = {
  ...
  sub: {
    ...
    es: 'Laponia llega a −30 °C en invierno, y en temporada las tallas adecuadas se agotan rápido. Scandinavian Outdoor tiene las primeras capas, chaquetas shell, manoplas y botas de invierno que de verdad aguantan, y envía a todo el mundo, así que todo le estará esperando cuando aterrice.',
