...
const KC_COPY: ProductAdCopy = {
  ...
  sub: {
    ...
    'pt-BR': 'Uma joalheria familiar desde 1933, com Kalevala Koru e outras marcas finlandesas e nórdicas no mesmo lugar. Útil quando você quer um presente que dura e chega rápido pela Europa, não mais uma lembrança de aeroporto.',
    'zh-CN': '自 1933 年传承的家族珠宝店,把 Kalevala Koru 与其他芬兰、北欧品牌汇聚一处。想要一件经久耐用、在欧洲快速送达的礼物,而不是又一件机场纪念品时,很合适。',
